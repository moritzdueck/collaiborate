export const layers = [
    ...
    {value: 1, label: "(0): Conv", type: 'convolution', color: "var(--purple)"},
    {value: 2, label: "(1): ReLU", type: 'relu', color: "var(--teal)"},
    {value: 3, label: "(2): MaxPool", type: 'max-pooling', color: "var(--orange)"},
    {value: 4, label: "(3): Conv", type: 'convolution', color: "var(--purple)"},
    {value: 5, label: "(4): ReLU", type: 'relu', color: "var(--teal)"},
    {value: 6, label: "(5): MaxPool", type: 'max-pooling', color: "var(--orange)"},
    {value: 7, label: "(6): Conv", type: 'convolution', color: "var(--purple)"},
    {value: 8, label: "(7): ReLU", type: 'relu', color: "var(--teal)"},
    {value: 9, label: "(8): MaxPool", type: 'max-pooling', color: "var(--orange)"},
